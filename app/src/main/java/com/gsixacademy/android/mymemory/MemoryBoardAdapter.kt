...
class MemoryBoardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val cardWidht=parent.width/boardSize.getWidht()-(2* MARGIN_SIZE)
        val cardWHeigh=parent.height/boardSize.getHeight()-(2* MARGIN_SIZE)
        val cardSideLenght=min(cardWidht,cardWHeigh)
